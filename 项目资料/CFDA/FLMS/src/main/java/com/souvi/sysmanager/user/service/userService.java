...
public class userService{
	 ...
	 * 根据角色Id,得到审批人的邮箱
	 */
	public List<User> getUserMailByRoleId(String roleId,String projectId){
		return userMapper.getUserMailByRoleId(roleId, projectId);
	}
	/*
	 * 根据审批阶段,得到审批人的邮箱
	 */
	public List<User> getUserMailByAuditStage(int auditStage,String foreignId){
		return userMapper.getUserMailByAuditStage(auditStage, foreignId);
	}
