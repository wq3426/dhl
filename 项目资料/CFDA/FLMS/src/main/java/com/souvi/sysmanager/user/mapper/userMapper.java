...
public interface userMapper {
	 ...
	 * 根据角色Id,得到审批人的邮箱
	 */
	List<User> getUserMailByRoleId(@Param("roleId")String roleId,@Param("projectId")String projectId);
	/*
	 * 根据审批阶段,得到审批人的邮箱
	 */
	List<User> getUserMailByAuditStage(@Param("auditStage")int auditStage,@Param("foreignId")String foreignId);
