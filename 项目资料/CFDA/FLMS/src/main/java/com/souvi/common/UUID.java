...
public final class UUID implements Serializable, Comparable {
	private static final long serialVersionUID = -0xbc9983f7986d852fL;
	...
	public static void main(String[] args) {
		...
		System.err.println(uid+" "+uid.replaceAll("-", "")+"  "+uid.replaceAll("-", "").length());
		/*int max = 100000;
		...
		System.out.println(list.size()+"  "+(list.size()==max));
		*/
