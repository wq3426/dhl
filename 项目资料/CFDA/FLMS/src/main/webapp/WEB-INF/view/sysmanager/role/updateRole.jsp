...
<div class="page-container">
	...
	<div class="left-content">
		<div class="mother-grid-inner">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a>角色编辑</a></li>
			</ol>
			<!--grid-->
			<div class="validation-system">
				<div class="validation-form">
					<form  action="<%=path%>/role/updateRole.do" method="post" id="commentForm">
						<div class="vali-form ">
							<div class="row">
								<div class="col-md-6 col-sm-offset-3  form-group1">
									<label class="control-label"><span style="color: red;">*</span>角色名:</label> 
									<input type="hidden" id="roleId" name="roleId" value="${role.roleId }">
	    							<input type="text" id ="roleName" name="roleName" class="form-control" value="${role.roleName }" placeholder="角色名">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6  col-sm-offset-3 form-group1">
									...
									<select name="roleStatus" id="roleStatus" class="form-control">
				    					<option value="Y" <c:if test="${role.roleStatus=='Y'}">selected</c:if> >启用</option>
				    					<option value="N" <c:if test="${role.roleStatus=='N'}">selected</c:if> >禁用</option>
				    				</select>
								</div>
							</div>
							<div class="row">
