...
public class DateUtil {
	 ...
	 * @throws ParseException 
	 */
	public static Long getMillisecondOfDateStr(String date) throws ParseException{
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 ...
	 * @throws ParseException 
	 */
	public static Long getMillisecondOfDateStrSSS(String date) throws ParseException{
	 ...
	 * @throws ParseException 
	 */
	public static String getYearStrOfDate(String sDate){
		if(null==sDate ||"".equalsIgnoreCase(sDate.trim())){
			return "";
		}
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	 ...
	 * @throws ParseException 
	 */
	public static String getDateStrOfDate(String sDate){
		if(null==sDate ||"".equalsIgnoreCase(sDate.trim())){
			return "";
		}
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @throws ParseException 
	 */
	public static String getTimeStrOfDate(String sDate){
		if(null==sDate ||"".equalsIgnoreCase(sDate.trim())){
			return "";
		}
		Calendar calendar = Calendar.getInstance();
