package com.souvi.sysmanager.aspect;
...
public class ValidAspect {
	...
	@Pointcut("execution(public * com.souvi.sysmanager.*.controller.*.*(..))")
    public void valid() {}
...
//                }
                ...
                result.put("result", 0);
                result.put("msg", validResult.iterator().next().getMessage());
